# 9. Introduction to Antivirus Evasion
...
Alternatively, we could use _AntiScan.Me_,[2](https://portal.offsec.com/courses/pen-300-9502/learning/introduction-to-antivirus-evasion-14689/introduction-to-antivirus-evasion-14988#fn-local_id_267-2) which provides a similar virus scanning service without distributing the results. However, this tool only scans against twenty-six antivirus engines and only generates three free scans before requiring a reasonable per-scan paid registration.
...
<figure><img src="https://static.offsec.com/offsec-courses/PEN-300/imgs/avi/9c92b732ff7bad9a214f76af88e5856d-avi_vba_flexhexfolders2.png" alt="Figure 21: VBA_PROJECT and NewMacros"><figcaption><p>Figure 21: VBA_PROJECT and NewMacros</p></figcaption></figure>
...
<figure><img src="https://static.offsec.com/offsec-courses/PEN-300/imgs/avi/44b967bd169edc0ef01a2755606ca7a0-avi_vba_flexhex_selectend.png" alt="Figure 26: Marking to the end of the VBA source code"><figcaption><p>Figure 26: Marking to the end of the VBA source code</p></figcaption></figure>
...
(Carrie Roberts, 2019), [https://github.com/clr2of8/Presentations/blob/master/DerbyCon2018-VBAstomp-Final-WalmartRedact.pdf](https://github.com/clr2of8/Presentations/blob/master/DerbyCon2018-VBAstomp-Final-WalmartRedact.pdf) [↩︎](https://portal.offsec.com/courses/pen-300-9502/learning/introduction-to-antivirus-evasion-14689/introduction-to-antivirus-evasion-14988#fnref-local_id_280-1)
...
To reduce the detection rate even further, we can perform a more complex obfuscation by converting the ASCII string to its decimal representation and then performing a Caesar cipher encryption on the result.[4](https://portal.offsec.com/courses/pen-300-9502/learning/introduction-to-antivirus-evasion-14689/introduction-to-antivirus-evasion-14988#fn-local_id_284-4)
...
We'll convert the entire string into a character array through the _ToCharArray_[5](https://portal.offsec.com/courses/pen-300-9502/learning/introduction-to-antivirus-evasion-14689/introduction-to-antivirus-evasion-14988#fn-local_id_284-5) method, and then run that output through a _Foreach_[6](https://portal.offsec.com/courses/pen-300-9502/learning/introduction-to-antivirus-evasion-14689/introduction-to-antivirus-evasion-14988#fn-local_id_284-6) loop, with the "%" shorthand.
...
Finally, each decimal value is appended to the output string and piped onto the clipboard through clip.[7](https://portal.offsec.com/courses/pen-300-9502/learning/introduction-to-antivirus-evasion-14689/introduction-to-antivirus-evasion-14988#fn-local_id_284-7) Running the PowerShell script produces the following output on the clipboard:
...
For each iteration of the loop, the entire encrypted string is sent to _Strawberries_. The function uses _Left_[8](https://portal.offsec.com/courses/pen-300-9502/learning/introduction-to-antivirus-evasion-14689/introduction-to-antivirus-evasion-14988#fn-local_id_284-8) to fetch the first three characters of the string and returns that value.
...
Once a character is returned, the _Almonds_ function is called inside the loop where the _Right_ function[9](https://portal.offsec.com/courses/pen-300-9502/learning/introduction-to-antivirus-evasion-14689/introduction-to-antivirus-evasion-14988#fn-local_id_284-9) will exclude the first three characters that we just decrypted.
...
<figure><img src="https://static.offsec.com/offsec-courses/PEN-300/imgs/avi/b07e1c3ce154f2d28ddddd7f741874d7-avi_wmi_asciiencrypt1.png" alt="Figure 35: Encryption string detection rate"><figcaption><p>Figure 35: Encryption string detection rate</p></figcaption></figure>
...
There are a number of ways to bypass heuristics in VBA that do not involve the use of Win32 APIs.[10](https://portal.offsec.com/courses/pen-300-9502/learning/introduction-to-antivirus-evasion-14689/introduction-to-antivirus-evasion-14988#fn-local_id_284-10) One simple technique is to check the document name when the macro runs.
...
For example, let's assume we named the document runner.doc. If we check the _Name_[11](https://portal.offsec.com/courses/pen-300-9502/learning/introduction-to-antivirus-evasion-14689/introduction-to-antivirus-evasion-14988#fn-local_id_284-11) property of the _ActiveDocument_ and find it to be anything but runner.doc, we'll exit to avoid heuristics detection. To further the obfuscation, we'll even encrypt this static document name (runner.doc in our case).
...
<figure><img src="https://static.offsec.com/offsec-courses/PEN-300/imgs/avi/07b05ed5c00f349c6ebbcdf82d5cbbe2-avi_wmi_enc_name1.png" alt="Figure 36: Encryption and document name check detection rate"><figcaption><p>Figure 36: Encryption and document name check detection rate</p></figcaption></figure>
...
3. The Windows 10 victim machine has an instance of Serviio PRO 1.8 DLNA Media Streaming Server installed. Exploit it[12](https://portal.offsec.com/courses/pen-300-9502/learning/introduction-to-antivirus-evasion-14689/introduction-to-antivirus-evasion-14988#fn-local_id_284-12) to obtain SYSTEM privileges while evading the Avira antivirus with real-time detection enabled.
...
(Wikipedia, 2020), [https://en.wikipedia.org/wiki/Obfuscation\_(software)](https://en.wikipedia.org/wiki/Obfuscation_\(software\)) [↩︎](https://portal.offsec.com/courses/pen-300-9502/learning/introduction-to-antivirus-evasion-14689/introduction-to-antivirus-evasion-14988#fnref-local_id_284-1)

2

(Microsoft, 2018), [https://docs.microsoft.com/en-us/office/vba/language/reference/user-interface-help/strreverse-function](https://docs.microsoft.com/en-us/office/vba/language/reference/user-interface-help/strreverse-function) [↩︎](https://portal.offsec.com/courses/pen-300-9502/learning/introduction-to-antivirus-evasion-14689/introduction-to-antivirus-evasion-14988#fnref-local_id_284-2)

3

(CodeBeautify, 2020), [https://codebeautify.org/reverse-string](https://codebeautify.org/reverse-string) [↩︎](https://portal.offsec.com/courses/pen-300-9502/learning/introduction-to-antivirus-evasion-14689/introduction-to-antivirus-evasion-14988#fnref-local_id_284-3)

4

(Carrie Roberts, 2019), [https://github.com/clr2of8/Presentations/blob/master/DerbyCon2018-VBAstomp-Final-WalmartRedact.pdf](https://github.com/clr2of8/Presentations/blob/master/DerbyCon2018-VBAstomp-Final-WalmartRedact.pdf) [↩︎](https://portal.offsec.com/courses/pen-300-9502/learning/introduction-to-antivirus-evasion-14689/introduction-to-antivirus-evasion-14988#fnref-local_id_284-4)

5

(Microsoft, 2020), [https://docs.microsoft.com/en-us/dotnet/api/system.string.tochararray?view=netframework-4.8](https://docs.microsoft.com/en-us/dotnet/api/system.string.tochararray?view=netframework-4.8) [↩︎](https://portal.offsec.com/courses/pen-300-9502/learning/introduction-to-antivirus-evasion-14689/introduction-to-antivirus-evasion-14988#fnref-local_id_284-5)

6

(SS64, 2020), [https://ss64.com/ps/foreach-object.html](https://ss64.com/ps/foreach-object.html) [↩︎](https://portal.offsec.com/courses/pen-300-9502/learning/introduction-to-antivirus-evasion-14689/introduction-to-antivirus-evasion-14988#fnref-local_id_284-6)

7

(Dr Scripto, 2014), [https://devblogs.microsoft.com/scripting/powertip-send-output-to-clipboard-with-powershell/](https://devblogs.microsoft.com/scripting/powertip-send-output-to-clipboard-with-powershell/) [↩︎](https://portal.offsec.com/courses/pen-300-9502/learning/introduction-to-antivirus-evasion-14689/introduction-to-antivirus-evasion-14988#fnref-local_id_284-7)

8

(Microsoft, 2018), [https://docs.microsoft.com/en-us/office/vba/language/reference/user-interface-help/left-function](https://docs.microsoft.com/en-us/office/vba/language/reference/user-interface-help/left-function) [↩︎](https://portal.offsec.com/courses/pen-300-9502/learning/introduction-to-antivirus-evasion-14689/introduction-to-antivirus-evasion-14988#fnref-local_id_284-8)

9

(Microsoft, 2018), [https://docs.microsoft.com/en-us/office/vba/language/reference/user-interface-help/right-function](https://docs.microsoft.com/en-us/office/vba/language/reference/user-interface-help/right-function) [↩︎](https://portal.offsec.com/courses/pen-300-9502/learning/introduction-to-antivirus-evasion-14689/introduction-to-antivirus-evasion-14988#fnref-local_id_284-9)

10

(Stefan Bühlmann, 2017), [https://github.com/joesecurity/pafishmacro/blob/master/code.vba](https://github.com/joesecurity/pafishmacro/blob/master/code.vba) [↩︎](https://portal.offsec.com/courses/pen-300-9502/learning/introduction-to-antivirus-evasion-14689/introduction-to-antivirus-evasion-14988#fnref-local_id_284-10)

11

(Microsoft, 2018), [https://docs.microsoft.com/en-us/office/vba/api/word.document.name](https://docs.microsoft.com/en-us/office/vba/api/word.document.name) [↩︎](https://portal.offsec.com/courses/pen-300-9502/learning/introduction-to-antivirus-evasion-14689/introduction-to-antivirus-evasion-14988#fnref-local_id_284-11)

12

(Petr Nejedly, 2017), [https://www.exploit-db.com/exploits/41959](https://www.exploit-db.com/exploits/41959) [↩︎](https://portal.offsec.com/courses/pen-300-9502/learning/introduction-to-antivirus-evasion-14689/introduction-to-antivirus-evasion-14988#fnref-local_id_284-12)
